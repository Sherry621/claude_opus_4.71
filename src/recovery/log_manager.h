...
public:
    ...
    UpdateLogRecord(txn_id_t txn_id, const RmRecord& old_value, const RmRecord& new_value, const Rid& rid, std::string table_name) 
        : UpdateLogRecord() {
        log_tid_ = txn_id;
...
public:
    ...
    void set_persist_lsn(lsn_t lsn) { persist_lsn_ = lsn; }
    lsn_t get_global_lsn() { return global_lsn_; }
...
private:    
    ...
    lsn_t last_lsn_in_buffer_ = INVALID_LSN;
}; 
